...
class RAGPanel:
    ...
    def add(self, title: str, text: str, relevance: float = 0.0, recency: float = 0.0):
        self.docs.append(Document(title=title, text=text, relevance=relevance, recency=recency))
