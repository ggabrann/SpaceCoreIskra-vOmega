...
- **Philosophy:** 03–07 — канон, грани, метрики, память, символы (см. [`docs/03_PHILOSOPHY_COMPLETE.md`](./docs/03_PHILOSOPHY_COMPLETE.md)).
...
- [`docs/METRICS_SLO.md`](./docs/METRICS_SLO.md) — целевые значения метрик и действия при отклонениях.
- [`docs/README_index.md`](./docs/README_index.md) — карта документации с краткими аннотациями.
- [`docs/19_QUICKSTART_GUIDE.md`](./docs/19_QUICKSTART_GUIDE.md) — пошаговый старт.
- [`docs/20_DEPLOYMENT_CHECKLIST.md`](./docs/20_DEPLOYMENT_CHECKLIST.md) — контрольный список релиза.

Каждый файл соответствует требованиям Manifest vΩ и поддерживается в актуальном состоянии через ритуалы журналов.
