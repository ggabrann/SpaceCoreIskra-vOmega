...
| `docs/` | Планирование релизов, manifests, архивы, включая комплект `agiagent_iskra_v3.5` с философией→рефлексией. 【F:docs/SPACECORE_CANON_MASTER_PLAN.md†L1-L20】【F:docs/agiagent_iskra_v3.5/index.md†L1-L18】|
